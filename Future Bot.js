...
client.on('message', message => {
    ...
    .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=534053307606499328&permissions=0&scope=bot`)  // حط اي دي بوتك
...
[❖═════ General Commands ═══════❖]
 ...
 Fid معلومات عن حسابك الشخصي

 Fserver معلومات حول السيرفر
 
 Fmove سحب عضو الى رومك الصوتي

 Fclear مسح الرسائل الموجوده في الروم بعدد

 Favatar يعرض اك صورتك الشخصية
 
 Fimage يعرض لك صورة السيرفر
 
 Fcredit يوريك كم الكريديت حقتك

 Fdaily يسوي لك سحب فلوس

 Frep يعطي ريب

 Fprofile معلومات عامة مع الصورة
 
[❖═════ Administrator Commands ═══════❖]

 Fban حضر عضو من السيرفر
 
 Fkick طرد عضو من السيرفر
 
 Fmute اعضاء ميوت كتابي لعضو في السيرفر
 
 Funmute فك الميوت عن عضو في السيرفر
 
 Fdac حذف جميع رومات السيرفر
 
 Fdar حذف جميع رتب السيرفر
 
 Fopenroom فتح المحادثة في الروم
 
 Fcloseroom قفل المحادثة في الرةوم

 Frole اعطاء رتبه لشخض معين
 
 Frole humans اعطاء رتب للبشريين
 
 Frole bots اعطاء رتبه للبوتات
 
 Frole all اعطاء رتبه للجميع سواء بشر او بوتات
...
client.login("NTM0MDUzMzA3NjA2NDk5MzI4.D1A8Vw.YR-VIZ5LEQGw-ISHr97VtfGUy3c");  // توكن حقق